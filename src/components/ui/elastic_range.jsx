...
export default function ElasticRange({
  defaultValue = 50,
  startingValue = 0,
  maxValue = 100,
  className = "",
...
function Range({
  ...
  return (
    <>
      ...
      >
        <motion.button
          onClick={() => updateValue(value - stepSize)}
          animate={{
        ...
        <div
          ref={sliderRef}
          className="relative flex w-full max-w-[90px] grow cursor-grab touch-none select-none items-center py-4"
        ...
        >
          <motion.div
            ...
            className="flex grow"
          >
            <div className="relative h-full grow overflow-hidden rounded-full bg-border">
              <div
      ...
      <p className="absolute transform -translate-y-4 text-xs font-medium tracking-wide text-text/70">
        {Math.round(value)}%
      </p>
    </>
  );
