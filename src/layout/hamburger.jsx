        ...
        {open && (
          ...
          >
            <div className="p-6 py-5 flex justify-between items-center border-b-2 border-primary">
              ...
              <button onClick={() => setOpen(false)} className="text-2xl text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="primary" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x-icon lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
              </button>
            </div>
