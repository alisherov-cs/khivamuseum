  ...
  const tickets = [
    {
      ...
      description:
        "Muzey-qo'riqxona barcha ko'rgazmalari va hududlariga to'liq kirish",
      features: [
        "🏛️ Barcha ko'rgazmalar",
        "🚶 Erkin aylanish",
        "📍 Barcha hududlar",
      ],
    ...
    <div className="flex py-[75px] justify-center">
      <div className="w-full sm:mx-[5%] flex shadow-[4px_4px_58px_0px_rgba(34,60,80,0.2)] min-h-[450px] bg-white rounded-lg">
        <div className="lg:w-[75%] w-full">
          <h1 className="text-3xl font-medium pb-0 p-7">History</h1>
          <div className="flex flex-col gap-y-3 mt-5 h-[350px] p-7 overflow-y-auto">
            {tickets.map((ticket, index) => (
              <div
                key={ticket.id}
                className={`group relative before:absolute before:top-0 before:left-0 before:bg-gray-400/20 before:rounded-3xl before:z-50 before:w-full before:h-full w-full ${
                  isVisible
              ...
              >
                {/* Magical Glow Effect */}
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${ticket.gradient} rounded-3xl blur-lg opacity-0  transition-all duration-300`}
                ></div>
                ...
                >
                  ...
                  {/* Ticket Content */}
                  <div className="p-5 relative flex md:flex-row-reverse flex-col justify-between items-start ">
                    {/* Animated Icon */}
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        ...
                        >
                          <span className="mr-4 pr-4 border-r-4 border-blue-600">
                            5X
                          </span>
                    ...
                    <div className="">
                      ...
                      <div className="space-y-3 mb-6">
                        {ticket.features.map((feature, featureIndex) => (
                          <div
                            key={featureIndex}
                            className={`flex items-center text-gray-700 transform transition-all`}
                            style={{
                  ...
                  <div className="p-5 pt-0 flex sm:flex-row flex-col-reverse gap-y-3 justify-between sm:items-center gap-x-3">
                    <button className="sm:py-3 py-[10px] px-6 duration-300 hover:opacity-80 rounded-xl text-base text-white bg-blue-800">Download pdf</button>
                    <div className="flex items-center gap-x-3">
                 <button className="sm:py-3 py-[10px] cursor-default sm:px-6 w-full rounded-xl text-base text-white bg-green-600">Paid <span className="pl-2"><i className="fa-regular fa-check-circle text-white"></i></span></button>
                    </div>
                  </div>
                </div>
              </div>
