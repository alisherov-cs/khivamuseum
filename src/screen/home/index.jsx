      ...
      <div className="lg:mb-[90px] sm:mb-[60px] mb-[40px]">
        <div className="flex items-center justify-center flex-col gap-3 mb-20 px-4">
          ...
          <p className="text-base text-center max-w-[1000px] text-shadow-text">
            Xiva davlat muzey qo'riqxonasining boy to'plamida asrlar davomida
            saqlanib kelgan noyob eksponatlar namoyish etilmoqda. An'anaviy
            keramika, milliy kiyimlar va qadimiy qurol-yarog'lar orqali Xorazm
            xalqining tarixini va madaniyatini kashf eting.
          </p>
        </div>
